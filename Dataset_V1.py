...
def loadAddressPair():
    ...
    df = pd.read_csv('FrenchEM2_V3.0.csv')
    ...
    for i in range(0, len(df)):
        ...
        df['INBUILDING'][i] = ' '.join(str(x) for x in L)
        df['INBUILDING'][i] = re.sub("\s\s+", " ", df['INBUILDING'][i])
        df['INBUILDING'][i] = df['INBUILDING'][i].strip()
        ...
        df['INBUILDINGK'][i] = ' '.join(str(x) for x in L)
        df['INBUILDINGK'][i] = re.sub("\s\s+", " ", df['INBUILDINGK'][i])
        df['INBUILDINGK'][i] = df['INBUILDINGK'][i].strip()
        ...
        df['EXTBUILDING'][i] = ' '.join(str(x) for x in L)
        df['EXTBUILDING'][i] = re.sub("\s\s+", " ", df['EXTBUILDING'][i])
        df['EXTBUILDING'][i] = df['EXTBUILDING'][i].strip()
        ...
        df['EXTBUILDINGK'][i] = ' '.join(str(x) for x in L)
        df['EXTBUILDINGK'][i] = re.sub("\s\s+", " ", df['EXTBUILDINGK'][i])
        df['EXTBUILDINGK'][i] = df['EXTBUILDINGK'][i].strip()
        ...
        df['POILOGISTIC'][i] = ' '.join(str(x) for x in L)
        df['POILOGISTIC'][i] = re.sub("\s\s+", " ", df['POILOGISTIC'][i])
        df['POILOGISTIC'][i] = df['POILOGISTIC'][i].strip()
        ...
        df['POILOGISTICK'][i] = ' '.join(str(x) for x in L)
        df['POILOGISTICK'][i] = re.sub("\s\s+", " ", df['POILOGISTICK'][i])
        df['POILOGISTICK'][i] = df['POILOGISTICK'][i].strip()
        ...
        df['ZONE'][i] = ' '.join(str(x) for x in L)
        df['ZONE'][i] = re.sub("\s\s+", " ", df['ZONE'][i])
        ...
        df['ZONEK'][i] = ' '.join(str(x) for x in L)
        df['ZONEK'][i] = re.sub("\s\s+", " ", df['ZONEK'][i])
        df['ZONEK'][i] = df['ZONEK'][i].strip()
        ...
        df['ROADNAME'][i] = ' '.join(str(x) for x in L)
        df['ROADNAME'][i] = re.sub("\s\s+", " ", df['ROADNAME'][i])
        df['ROADNAME'][i] = df['ROADNAME'][i].strip()
        ...
        df['ROADNAMEK'][i] = ' '.join(str(x) for x in L)
        df['ROADNAMEK'][i] = re.sub("\s\s+", " ", df['ROADNAMEK'][i])
        df['ROADNAMEK'][i] = df['ROADNAMEK'][i].strip()
        ...
        df['CITY'][i] = ' '.join(str(x) for x in L)
        df['CITY'][i] = re.sub("\s\s+", " ", df['CITY'][i])
        ...
        df['CITYK'][i] = ' '.join(str(x) for x in L)
        df['CITYK'][i] = re.sub("\s\s+", " ", df['CITYK'][i])
        df['CITYK'][i] = df['CITYK'][i].strip()
    ...
    for i in range(0, len(df)):
        ...
        #    I1.insert(6,df['ZIPCODE'][i])
        I1.insert(6, df['CITY'][i])
        # I1.insert(7, df['Autre'][i])
        ...
        #   I2.insert(6,df['ZIPCODEK'][i])
        I2.insert(6, df['CITYK'][i])
        # I2.insert(7, df['AutreK'][i])
